...
// But since we haven't implemented with() or empty() yet:        
        def oneToFive = bst.named("One to five")
        oneToFive.at("one") put(1)
        oneToFive.at("two") put(2)
        oneToFive.at("three") put(3)
        oneToFive.at("four") put(4)
        oneToFive.at("five") put(5)
          
        def evens = bst.named("Evens")
        evens.at("two") put(2)
        evens.at("four") put(4)
        evens.at("six") put(6)
        evens.at("eight") put(8)
          
        def empty = bst.named("Empty")
